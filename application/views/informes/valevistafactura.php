...
foreach($valevista as $value){
    ...
    <td align="center"><?=$value['BancoEmisor']?> <?=$value['CodigoTransaccion']?> <?=$value['banco']?></td>
    <td align="right"><?=number_format($value['MontoFactura'],0,',','.')?></td>

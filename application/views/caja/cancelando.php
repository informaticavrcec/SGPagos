...
<form method="post" action="/caja/cancelarpago">
<table width="100%" border="0" cellpadding="3" cellspacing="0" align="center">
<tr>
<td class="titulo">Detalle pago</td>
</tr>
<tr>
<td height="40"> <input type="submit" value="Abortar pago" /> 
...
foreach($pagos as $value){
	...
	foreach($value['detalle'] as $val){
        ...
        <td align="center"><a href="/caja/eliminarpago/<?=$value['IDTipoPago']?>/<?=$val['id']?>/<?=base64_encode(implode(',',$a_pagar))?>" class="eliminar">Eliminar pago</a></td>       
        </tr>
        <?
	}
...
<form method="post" action="/caja/procesapago">
<input type="hidden" name="a_pagar[]" value="<?=implode(',',$a_pagar)?>" />
<input type="hidden" name="rut" value="<?=set_value('rut')?>" />
